...
public void buildGUI(){
 theFrame = new JFrame("BASIC BEAT BOX");
...
try {
FileOutputStream fileStream = new FileOutputStream(new File("Checkbox.txt"));
...
try{
FileInputStream fileIn = new FileInputStream(new File("Checkbox.txt"));
